  ...
  $.fn.extend({
    popConfirm: function (options) {
      var defaults = {
          ...
          yesBtn: 'Yes',
          noBtn: 'No',
          classYesBtn: 'btn-danger',
          classNoBtn: 'btn-default'
        },
        last = null;
      ...
      return this.each(function () {
        ...
        self.popover({
          ...
          content: options.content + '<p class="button-group" style="margin-top: 10px; text-align: center;"><button type="button" class="btn btn-small ' + options.classNoBtn + ' confirm-dialog-btn-abort">' + options.noBtn + '</button> <button type="button" class="btn btn-small ' + options.classYesBtn + ' confirm-dialog-btn-confirm">' + options.yesBtn + '</button></p>'
        }).click(function (e) {
          if (last && last !== self) {
