                  ...
                  <div class="x_title">
                   <div class="x_content">
                    <h2><?php echo "Status Waktu EOD";?><small> | <?php date_default_timezone_set("Asia/Jakarta"); echo date('l, d/m/Y H:i:s');?></small></h2>
          ...
          <form action="<?php echo base_url('/report_waktu_eod');?>" method="post">
          </br></br>
                         Host :  
              ...
              <div class="col-md-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="row" style="border-bottom: 1px solid #E0E0E0; padding-bottom: 5px; margin-bottom: 5px;">
                      <div class="col-md-12" style="overflow:hidden; height: 33em;" id="show2">
