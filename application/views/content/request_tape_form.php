                ...
                <form  method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select class="form-control" name="set_tape" id="set_tape"> 
                                        <option value ="Kosong" <?php if($data_tape->set_tape == "Kosong") echo 'selected="selected"';?> >Kosong</option> 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select class="form-control" name="state" id="state" ?>"> 
                                        <option value ="Kosong" <?php if($data_tape->state == "Kosong") echo 'selected="selected"';?> >Kosong</option> 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select class="form-control" name="status" id="status" ?>"> 
                                        <option value ="Kosong" <?php if($data_tape->status == "Kosong") echo 'selected="selected"';?> >Kosong</option> 
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                            ...
                            <?php } ?>
                            <?php if ($this->fitur == 'Tambah' || $this->fitur == 'Masuk' || $this->fitur == 'Request') { ?>
