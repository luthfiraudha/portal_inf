            ...
            <div class="x_content">
                ...
                <form  method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                     ...
                     if ($this->fitur == 'Pakai') { ?>
                        ...
                        <input type="hidden" name="id" value="<?php echo $inven_detail->id; ?>">
                        <?php } ?>
                        <input type="hidden" name="record_id" value="<?php echo $answer_detail->record_id; ?>">
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                            <!-- <a class="btn btn-sm bg-blue" href="<?php echo base_url($this->cname . '/action/view/' . $answer_detail->record_id); ?>"><i class="fa fa-arrow-left"></i> Kembali</a> -->
                             <a class="btn btn-sm bg-blue" onclick="history.go(-1);" href="#"><i class="fa fa-arrow-left"></i> Kembali</a>
