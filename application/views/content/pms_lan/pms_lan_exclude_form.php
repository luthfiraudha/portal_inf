                ...
                <form  method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data" >
                    <?php if ($this->fitur == 'Lihat') { ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" name="keterangan_exclude" required="required" id="keterangan_exclude" class="form-control col-md-7 col-xs-12" value="" >
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-1">
                            ...
                            <?php } ?>
                            <?php if ($this->fitur == 'Tambah exclude' || $this->fitur == 'Ubah') { ?>
