            ...
            <div class="x_content">
                ...
                <form  method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data" >
                    <?php if ($this->fitur == 'Lihat') { ?>
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" >PIC BRI
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" name="bai_bri" required="required" class="form-control col-md-7 col-xs-12" value="">
                            </div>
                        </div>

                         <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" >PIC Vendor
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" name="bai_vendor" required="required" id="namafitur" class="form-control col-md-7 col-xs-12" value="" >
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" >Tanggal Pengerjaan
                            </label>
                            
                               <div class="control-group">
                                <div class="controls">
                                        <div class="col-md-6 col-sm-6 col-xs-12 xdisplay_inputx form-group has-feedback">
                                             <input type="text" name="bai_tgl" class="form-control has-feedback-left" id="single_cal1" value="">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" >Tanggal Penyerahan Ke INF
                            </label>
                            <div class="control-group">
                                <div class="controls">
                                        <div class="col-md-6 col-sm-6 col-xs-12 xdisplay_inputx form-group has-feedback">
                                             <input type="text" name="bai_ke_inf" class="form-control has-feedback-left" id="single_cal2" value="">
                                                <span class="fa fa-calendar-o form-control-feedback left" aria-hidden="true"></span>
                         ...
                         <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" >Tanggal Penyerahan Ke Provider
                            </label>
                            <div class="control-group">
                                <div class="controls">
                                        <div class="col-md-6 col-sm-6 col-xs-12 xdisplay_inputx form-group has-feedback">
                                             <input type="text" name="bai_ke_provider" class="form-control has-feedback-left" id="single_cal3" value="">
                                                <span class="fa fa-calendar-o form-control-feedback left" aria-hidden="true"></span>
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-1">
                            ...
                            <?php } ?>
                            <?php if ($this->fitur == 'Tambah BAI' || $this->fitur == 'Ubah') { ?>
