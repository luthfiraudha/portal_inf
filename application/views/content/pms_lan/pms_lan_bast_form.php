            ...
            <div class="x_content">
                ...
                <form  method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data" >
                    <?php if ($this->fitur == 'Lihat') { ?>
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" >Tanggal BAST
                            </label>
                            
                               <div class="control-group">
                                <div class="controls">
                                        <div class="col-md-6 col-sm-6 col-xs-12 xdisplay_inputx form-group has-feedback">
                                             <input type="text" name="bast_tgl" class="form-control has-feedback-left" id="single_cal1" value="">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" >Penandatangan
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" name="bast_ttd" required="required" id="namafitur" class="form-control col-md-7 col-xs-12" value="" >
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-1">
                            ...
                            <?php } ?>
                            <?php if ($this->fitur == 'Tambah BAST' || $this->fitur == 'Ubah') { ?>
