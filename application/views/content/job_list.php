                    ...
                    ?>
                            <tr>
                                ...
                                <td style="text-align:center" width="140px">
                                    ...
                                    <a title='Edit' href=" <?php echo base_url($this->cname . '/action/edit/' . $job->job_id);?>" class='btn btn-circle btn-sm bg-blue'>
                                        <i class='fa fa-edit'></i>
                                    </a>

                                    <a title='Delete' data-href=" <?php echo base_url($this->cname . '/action/delete/' . $job->job_id);?>" class='btn btn-circle btn-sm bg-red' data-toggle="modal" data-target=".delete-modal">
