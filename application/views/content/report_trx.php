                  ...
                  <div class="x_title">
                   <div class="x_content">
                    <h2><?php echo "Status Transaksi";?><small> | <?php date_default_timezone_set("Asia/Jakarta"); echo date('l, d/m/Y H:i:s');?></small></h2>
          ...
          <form action="<?php echo base_url('/report_trx');?>" method="post">
          </br></br>
                         
				<input type="hidden" name="tipe" required="required" value="perhost" >
