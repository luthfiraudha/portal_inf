                    ...
                    <?php if ($this->fitur == 'Lihat') { ?>
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <p>: <?php echo $kategori_detail->kategori_nama; ?><p>
                            </div>
                        </div>
                        ...
                        <?php if ($this->fitur == 'Ubah') { ?>
                            <input type="hidden" name="kategori_id" value="<?php echo $kategori_detail->kategori_id; ?>">
                        <?php } ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" name="kategori_nama" required="required" class="form-control col-md-7 col-xs-12" value="<?php if ($this->fitur == 'Ubah') echo $kategori_detail->kategori_nama; ?>">
                            </div>
                        </div>
