                        ...
                        <div class="col-md-6">
                            ...
                            <div class="btn-group">
                                <a href="<?php echo base_url($this->cname . '/add')?>" class="btn btn-small sbold bg-green" >
                                    <i class="fa fa-plus"></i> Pakai Anggaran
                                </a>
                            </div>
                            <!-- <div class="btn-group">
...
<!-- 
                ...
                <div class="row">
                <table id="data-pakaianggaran" class="table table-striped table-bordered" >
                    <thead>
                        <tr>
                            <th rowspan="1">NO</th>
                            <th width="" rowspan="1">POS ANGGARAN</th>
                            <th width="" rowspan="1">KANWIL / DIVISI</th>
                            <th width="" rowspan="1">CABANG / BAGIAN</th>
                            <th width="" rowspan="1">JUDUL IP</th>
                            <th width="" rowspan="1">PEMBUAT</th>
                            <th width="" rowspan="1">NILAI</th>
                            <th width="" rowspan="1">TANGGAL</th>
                            <th width="" rowspan="1">FILE IP</th>
