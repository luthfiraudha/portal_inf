...
?>
            <div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="btn-group">
                            <a href="<?php echo base_url('data_tape_of/add')?>" class="btn btn-small sbold bg-green" >
                                <i class="fa fa-plus"></i> New Tape OF 
                            </a>
                        </div>
                    ...
                    <form  id="form-filter" class="form-horizontal form-label-left" >
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" name="hostnameapp" id="hostnameapp" required="required" class="form-control col-md-7 col-xs-12" value="">
                            </div>
                        </div>
			<!-- <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" name="fiturapp" id="fiturapp" required="required" class="form-control col-md-7 col-xs-12" value="">
                            </div>
                        </div>-->
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" name="ipapp" id="ipapp" required="required" class="form-control col-md-7 col-xs-12" value="">
                            </div>
                        </div>
                            <div class="form-group">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <input type="number" name="size" min="0" id="size" required="required" class="form-control col-md-7 col-xs-12" value="">
                            </div>
                            <div class="col-md-3 col-sm-3 col-xs-6">
                ...
                <div class="row">
                <table id="data-tape-of-a" class="table table-striped table-bordered">
                    <thead>
                        <tr>
                            <th width="30px">No</th>
