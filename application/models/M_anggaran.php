...
class M_anggaran extends CI_Model {
    ...
    private function _get_datatables_query()
    {
        ...
        $this->db->from($this->table_ajax.' a');
    ...
    function get_datatables($table='', $column_order=array(), $column_search=array(), $order=array())
    {
        ...
        $this->order = $order;
        $this->db->select('a.*, (a.nilai_anggaran - b.total_pakai) as sisa');
        $this->db->join('( SELECT DISTINCT a.id_anggaran, SUM(a.nilai) as total_pakai 
        FROM pakai_anggaran a ) b', 'a.id_anggaran = b.id_anggaran','LEFT');
